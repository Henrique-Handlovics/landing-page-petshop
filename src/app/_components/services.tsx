...
const services = [
    {
        title: "Banho e Tosa",
        description: "Inclui banho com produtos específicos para o tipo de pelagem e pele do animal, corte de unhas, limpeza das orelhas e tosa personalizada (higiêne ou estilizada).",
        duration: "1h",
        price: "$50",
        icon: <Scissors />,
            ...
            <div className="container mx-auto px-4">
                 ...
                 <div>
                    ...
                    <div className="relative">
                                    ...
                                    <div key={index} className='flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3'>
                                        <article className='bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col'>
                                            ...
                                            <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                                ...
                                                target='_black'
                                                className='flex items-center justify-center gap- hover:bg-red-500 px-4 py-1 rounded-md duration-300'
                                                >
                        ...
                        >
                            <ChevronLeft 
                            className='w-4 h-6 text-gray-60' 
                            />
                        </button>
